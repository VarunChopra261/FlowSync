...
import {
    Command,
    CommandDialog,
    CommandEmpty as CommandEmptyImport,
    CommandGroup,
    CommandInput,
    CommandItem,
    CommandList,
...
export interface Option {
  ...
  >(
    (
      ...
      const { useCommandState, CommandPrimitive } = React.useMemo(() => {
            ...
            <div className="flex flex-wrap gap-1">
              ...
              <CommandPrimitive.Input
                ...
                onValueChange={(value: React.SetStateAction<string>) => {
                  setInputValue(value)
                  const stringValue = typeof value === 'function' ? value(inputValue) : value
                  inputProps?.onValueChange?.(stringValue)
                }}
